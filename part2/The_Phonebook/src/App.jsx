...
const App = () => {
    ...
    function handleSubmit(e) {
        ...
        if (personIfExists) {
            if (!checkIfSameNumber(personIfExists)) {
                ...
                numberService.changeNumber(personIfExists.id, newPerson)
                    .then(data => {
                        setPersons(prevPersons => {
                            return prevPersons.map(person => person.id !== personIfExists.id
                                ? person : data)
                        })
                    })
                return
    ...
    const filteredNumbers = persons.filter(person => person.name.toLowerCase()
